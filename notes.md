...
- 1024 - 49151: requesting entities
- 49152 - 65535: dynamic connections
...
- Domain
  ...
  - If specified, then cookies are available on the server and its subdomains.
  - If not specified, the cookies are available on the server but not on its subdomains.
- Path
...
- SameSite
  ...
  - This provides some protection against cross-site request forgery attacks.
  - It takes three possible values: `Strict`, `Lax`, and `None`
- HTTPOnly
  - prevents access to cookie values via JavaScript.
